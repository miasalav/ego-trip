  ...
  return (
    ...
    <div className='relative'>
        <section ref={scrollRef}  className="w-full flex flex-wrap justify-left items-center text-font-color overflow-y-scroll h-[400px] scrollbar-thin scrollbar-thumb-font scrollbar-track-transparent px-8">
            <div className='mb-4'>
                <h3 className="text-2xl text-center mb-4 -tracking-[1px]">✦ in-flight entertainment ✦</h3>
                <ul className='pl-4 mt-2 text-xs'>
                    <li className='leading-5 mb-5'><strong className='border py-1 px-2 rounded-2xl mr-1'>music by</strong><a className='underline' href="https://www.instagram.com/gi____gi_____/" target='_blank'>Gi Gi</a> from 4pm-midnight</li>
                    <li className='leading-5 mb-5'><strong className='border py-1 px-2 rounded-2xl'>movement by</strong> body time will lead a movement workshop from 4pm - midnight (register) (credit to the fabulous <a className='underline mx-2' href="https://instagram.com/arriverflush" target='_blank'>@arriverflush</a> for this lovely idea!) </li>
