  ...
  return (
    ...
    <div className='relative'>
        <section ref={scrollRef} className="w-full flex flex-wrap justify-center text-font-color overflow-y-scroll h-[400px] scrollbar-thin scrollbar-thumb-font scrollbar-track-transparent px-3">
            <h2 className="flex text-xl text-center font-bold mb-4 uppercase tracking-[1px]">Trip Treats</h2>
            <div className='mb-4 w-full'>
                ...
                <ul className='pl-4 text-xs list-disc mb-4'>
                ...
                <h4 className='text-md'><strong>Food (Sweet)</strong></h4>
                <ul className='pl-4 text-xs list-disc mb-4'>
