...
const InfoBox = () => {
  ...
  return (
    <>
    <section className="w-full flex flex-wrap justify-left text-font-color overflow-y-scroll h-[400px] scrollbar-thin scrollbar-thumb-font scrollbar-track-transparent px-3">
        <div className='mb-4 w-full'>
            <h2 className="text-xl text-center font-bold flex justify-center">Before Your Trip <FaFly className="ml-2" /></h2>
            <h3 className="text-lg">The 5 W's</h3>
        ...
        <div className='mb-4'>
            <h3 className="text-lg">Will there be food?</h3>
            <ul className='pl-4 text-sm list-disc'>
        ...
        <div className='mb-4'>
            <h3 className="text-lg">Is there anything else I need to know?</h3>
